...
//		Reading data from excel file
		...
		String orgnames=eu.getDataFromExcelFile("org", 10, 2)+ju.getRandomNumber();
...
//		SEARCH FOR ORGANIZATION
		op.getSearchEdt().sendKeys(orgnames);
		wdu.select(op.getSearchDD(), "Organization Name");
		op.getSearchBtn().click();
		
		
//		IN DYNAMIC WEBTABLE SELECT AND DELETE ORGANIZATION
		driver.findElement(By.xpath("//a[text()='"+orgnames+"']/../../td[8]/a[text()='del']")).click();
